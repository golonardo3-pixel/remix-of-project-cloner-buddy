...
const nicheTemplateMap: Record<string, NicheTemplate> = {
  ...
  "pet shop": {
    heroTitle: (city) => `Seu pet passou mal?\nAtendimento imediato em ${city}`,
    heroSubtitle: (city, company) => `Não espere piorar. O ${company} tem veterinário disponível agora e atendimento rápido pra banho, tosa e emergências em ${city}.`,
    heroImage: heroPetshop,
    heroVideo: "https://videos.pexels.com/video-files/4588455/4588455-hd_1920_1080_25fps.mp4",
    urgencyBadge: (city) => `⚡ Atendimento veterinário disponível agora em ${city}`,
  ...
  "baterias": {
    heroTitle: (city) => `Carro não liga?\nBateria na sua porta em ${city}`,
    heroSubtitle: (city, company) => `Ficou na mão? A ${company} entrega e instala a bateria no local em até 40 minutos. Socorro 24h em ${city}. Chame agora.`,
    heroImage: heroBatteries,
    heroVideo: "https://videos.pexels.com/video-files/5377700/5377700-hd_1920_1080_25fps.mp4",
    urgencyBadge: (city) => `⚡ Socorro 24h em ${city} – entrega em até 40 minutos`,
    ...
    services: [
      { title: "Bateria para Carros", desc: "Todas as marcas e modelos. Entrega e instalação grátis em ${city}." },
      { title: "Bateria para Motos", desc: "Moto não liga? Resolvemos rápido com instalação inclusa." },
      { title: "Socorro 24 Horas", desc: "De madrugada, final de semana, feriado. A gente vai até você." },
...
const defaultTemplate: NicheTemplate = {
  ...
  heroVideo: undefined,
  urgencyBadge: (city) => `⚡ Atendimento imediato em ${city} – não espere piorar`,
  aboutLabel: "Por que agir agora?",
